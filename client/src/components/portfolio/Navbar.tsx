  ...
  return (
    ...
    >
      <div className="w-full relative flex items-center justify-between">
        ...
        <div className="flex-shrink-0 max-w-7xl mx-auto w-full flex items-center justify-between">
          <div className="pl-6">
          ...
          <div className="hidden md:flex items-center justify-center gap-8 flex-1 absolute left-1/2 transform -translate-x-1/2">
          ...
          {/* Hire button aligned to viewport edge */}
          <div className="hidden md:flex justify-end flex-shrink-0 pr-6">
            <a 
